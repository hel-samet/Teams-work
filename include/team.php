     ...
     <div class="container-xxl py-6">
            <div class="container">
                <div class="mx-auto text-center wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <h1 style="font-family: 'battambang', cursive;  font-weight: 300;" class="mb-5">ជួបជាមួយសមាជិកក្រុមរបស់យើង</h1>
                </div>
                <div class="row g-4 ">
                    ...
                    <div class="col-lg-4 col-sm-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href="https://www.facebook.com/sok.thida.37201" target ="_blank"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href="#"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            ...
                            <p class="mb-4">designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="img/team6.png" alt="CVDMRRS">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href="#"><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href="#"><i class="fab fa-linkedin-in"></i></a>
